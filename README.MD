...
Solscan → puxa meta + holders (dados on-chain)
Birdeye → puxa mercado + liquidez + volume
Normalizador → une tudo num snapshot único
Rotas → permitem consultar snapshot cru ou já analisado pelo GP